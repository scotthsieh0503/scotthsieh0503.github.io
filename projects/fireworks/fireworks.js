...
function Firework( sx, sy, ty ) {
	...
	this.distanceToTarget = calculateDistance( sx, sy, sx, ty );
...
function loop() {
	...
	if( timerTick >= timerTotal ) {
		...
		fireworks.push( new Firework( random(0,WIDTH), HEIGHT, random( 0, HEIGHT / 2 ) ) );
		timerTick = 0;
	} else {
		timerTick++;
	}
